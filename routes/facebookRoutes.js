...
// router.get('/facebook/pages/:accountId', authMiddleware, facebookController.getFacebookPages);
router.post('/facebook/post', authMiddleware, facebookController.postToFacebook);
// router.get("/facebook/feed-dialog-url", authMiddleware, facebookController.getFacebookFeedDialogUrl);
